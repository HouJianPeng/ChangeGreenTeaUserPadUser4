...
-(void)setUpPickView{
    ...
    pickView.frame=CGRectMake(0, ZHToobarHeight,[UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height-ZHToobarHeight);
...
-(void)setUpDatePickerWithdatePickerMode:(UIDatePickerMode)datePickerMode{
    ...
    datePicker.frame=CGRectMake(0, ZHToobarHeight, datePicker.frame.size.width,[UIScreen mainScreen].bounds.size.height-ZHToobarHeight);
