...
//    [cell.pushButton addTarget:self action:@selector(submitClick:) forControlEvents:(UIControlEventTouchUpInside)];
    return cell;
}
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [[CameraTakeMamanger sharedInstance] cameraSheetInController:self.infoVC handler:^(UIImage *image, NSString *imagePath) {
